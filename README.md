...
~~~
Enter the plain text:Subbiah

 Enter the key value:18

 
 	 PLAIN TEXt: Subbiah
 
 	 ENCRYPTED TEXT:K�ttasz
 
 	 AFTER DECRYPTION : Subbiah
~~~
...
~~~
## OUTPUT:
![image](https://github.com/user-attachments/assets/38be16be-5183-44a1-bc9e-bda24dfac27d)
